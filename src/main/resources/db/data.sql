...
('v1', 'OTP_VERIFIED', 'NEXT', 'PROFILE_COMPLETED', false, 'UI', ARRAY['USER'], 3, '[]'),

-- Profile and documents
('v1', 'PROFILE_COMPLETED', 'NEXT', 'DOC_UPLOADED', false, 'UI', ARRAY['USER'], 3, '[]'),
('v1', 'DOC_UPLOADED', 'NEXT', 'EKYC_PENDING', true, 'UI', ARRAY['USER', 'SYSTEM'], 3, '[]'),
...
-- Final steps
('v1', 'AML_CLEARED', 'NEXT', 'ACCOUNT_CREATED', false, 'UI', ARRAY['USER', 'SYSTEM'], 3, '[]'),
